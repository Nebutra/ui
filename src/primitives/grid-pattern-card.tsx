...
export interface GridPatternCardProps extends Omit<MotionDivProps, "children"> {
  /** Card content */
...
export function GridPatternCard({
  ...
  return (
    <motion.div
      className={cn(
        "border w-full rounded-[var(--radius-md)] overflow-hidden",
 ...
 */
export function GridPatternCardBody({ className, ...props }: GridPatternCardBodyProps) {
